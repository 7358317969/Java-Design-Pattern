...
public class TestServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
	    ...
	    //write message
	    pw.println("<h1 style='color:red;text-align:center'> TestServlet form WebProj1 </h1>");
	    ...
	    pw.println("<br>parent class Loader:"+this.getClass().getClassLoader().getParent().getClass().getName());
