...
public class SingletonCustomerLoaderTest1 {
	...
	public static void main(String[] args)throws Exception {
      ...
      p2= method.invoke(null);
         ...
         // loader2=new URLClassLoader(new URL[] {new URL("file:/F:/Worskpaces/DesignPatterns/NTDP912/SingletonDP2-ClassLoaders/sdp.jar")},null);
		    Class<?> clazz2=loader2.loadClass("com.nt.sdp.Printer2");
